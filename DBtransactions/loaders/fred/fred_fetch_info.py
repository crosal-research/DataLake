...
INFO_FRED: List[Tuple[str]] = [('FRED.UNRATE', 'TAXA DE DESEMPREGO DOS E.U.A.', 'FRED_ECON', 'MENSAL'),
             ...
             ('FRED.VXEWZCLS', 'VOLATILIDADE IMPLICITA DO ETF EWZ DE ACÕES BRAZILEIRAS', 'FRED_FIN', 'DIARIA')]
